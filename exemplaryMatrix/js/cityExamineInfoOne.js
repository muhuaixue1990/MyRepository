...
$(function(){
	...
	$("#nextStep").click(function(){
		window.location.href = window.location.href = rootPath+"/page/jsp/exemplaryMatrix/cityExamineInfoTwo.jsp?applicationUserCode="+applicationUserCode+"&applicationId="+applicationId+"&sendThirdTypeFlag="+sendThirdTypeFlag;
	})
		...
		success: function(data, textStatus){
			...
			if(status == "1"){
				...
				for(var i=0;i<cooperationFacilitatingAgencies.length;i++){
					...
					html += '<td width="40%" title="'+cooperationFacilitatingAgencies[i].serviceItems+'">'+cooperationFacilitatingAgencies[i].serviceItems+'</td>';
		...
		success: function(data, textStatus){
			...
			if(status == "1"){
				...
				for(var i=0;i<serviceFunctions.length;i++){
					...
					html += '<td width="40%" title="'+serviceFunctions[i].serviceScale+'">'+serviceFunctions[i].serviceScale+'</td>';
