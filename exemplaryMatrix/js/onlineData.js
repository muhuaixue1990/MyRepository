...
$(function(){
	...
	$("#serviceType").val(paramServiceType);
	$("#serviceId").val(paramServiceId);
...
function getInfoByParams(){
	$(".serviceType").empty();
	var params = {"params.serviceId":paramServiceId}
	$.ajax({
		type: "post",
		...
		success: function(data, textStatus){
			...
			if(status == 0){
				$.ajax({
					type: "post",
					url: rootPath+"/exemplaryMatrixBackstage/findOnlineDataById.action",
					async : false,
					timeout : 30000,
					dataType:'json',
					data: params,
					...
					success: function(data1, textStatus){
						var status1 = data1['status'];
						if(status1 == '1'){
							var exemplaryMatrixOnlineData = data1['exemplaryMatrixOnlineData'];
							$("input[name='exemplaryMatrixServiceData.activityName']").val(exemplaryMatrixOnlineData.serviceName);
							$("input[name='exemplaryMatrixServiceData.activityTime']").val(exemplaryMatrixOnlineData.serviceTime);
							$("input[name='exemplaryMatrixServiceData.activityAddress']").val(exemplaryMatrixOnlineData.serviceAddress);
							
							var html = "";
							if('103000001' == exemplaryMatrixOnlineData.serviceSort){
								//信息服务
								html = "<option value='103000001'>信息服务</option>";
							}else if('103000004' == exemplaryMatrixOnlineData.serviceSort){
								//人才培训
								html = "<option value='103000004'>人员培训</option>";
							}else if('103000003' == exemplaryMatrixOnlineData.serviceSort){
								//技术创新和质量服务
								html = "<option value='103000003'>创新支持</option>";
							}else if('103000002' == exemplaryMatrixOnlineData.serviceSort){
								//创业服务
								html = "<option value='103000002'>创业辅导</option>";
							}else if('103000006' == exemplaryMatrixOnlineData.serviceSort){
								//投融资服务
								html = "<option value='103000006'>投融资服务</option>";
							}else if('103000005' == exemplaryMatrixOnlineData.serviceSort){
								//市场开拓
								html = "<option value='103000005'>市场营销</option>";
							}else if('103000007' == exemplaryMatrixOnlineData.serviceSort){
								//管理咨询
								html = "<option value='103000007'>管理咨询</option>";
							}else if('103000008' == exemplaryMatrixOnlineData.serviceSort){
								//法律服务
								html = "<option value='103000008'>专业服务</option>";
							}
				...
				for(var i=0;i<exemplaryMatrixServiceDatas.length;i++){
					...
					var html = "";
					if('103000001' == exemplaryMatrixServiceDatas[i].activityClass){
						//信息服务
						html = "<option value='103000001'>信息服务</option>";
					}else if('103000004' == exemplaryMatrixServiceDatas[i].activityClass){
						//人才培训
						html = "<option value='103000004'>人员培训</option>";
					}else if('103000003' == exemplaryMatrixServiceDatas[i].activityClass){
						//技术创新和质量服务
						html = "<option value='103000003'>创新支持</option>";
					}else if('103000002' == exemplaryMatrixServiceDatas[i].activityClass){
						//创业服务
						html = "<option value='103000002'>创业辅导</option>";
					}else if('103000006' == exemplaryMatrixServiceDatas[i].activityClass){
						//投融资服务
						html = "<option value='103000006'>投融资服务</option>";
					}else if('103000005' == exemplaryMatrixServiceDatas[i].activityClass){
						//市场开拓
						html = "<option value='103000005'>市场营销</option>";
					}else if('103000007' == exemplaryMatrixServiceDatas[i].activityClass){
						//管理咨询
						html = "<option value='103000007'>管理咨询</option>";
					}else if('103000008' == exemplaryMatrixServiceDatas[i].activityClass){
						//法律服务
						html = "<option value='103000008'>专业服务</option>";
					}
					$(".serviceType").append(html);
