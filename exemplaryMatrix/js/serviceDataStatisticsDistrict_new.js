...
$(function(){
	//加高亮
	$("#exemplaryMatrixServiceDataStatisticsDistrict").addClass("leeOn");
		...
		success: function(data, textStatus){
			...
			if(statementAuditList.length > 0){
				for(var i=0; i<statementAuditList.length; i++){
					...
					html += '<td title="'+statementAuditList[i].matrixName+'">'+statementAuditList[i].matrixName+'</td>';
				...
				$('.no-data').show()*/
				alert("未查询到数据");
				html += '<tr><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td></tr>';
			}
