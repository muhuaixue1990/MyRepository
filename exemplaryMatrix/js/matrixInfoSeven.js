...
$(function(){
	...
	$("#lastStep").click(function(){
		window.location.href = rootPath+"/page/jsp/exemplaryMatrixNew/matrixInfoSix.jsp";
	})
...
function submitMatrixApplication(){
	...
	if(saveFlag){
		...
		if(pageOne && pageTwo && pageThree && pageFour && pageFive && pageSix){
			...
			window.location.href = rootPath+"/page/jsp/exemplaryMatrixNew/matrixInfoFour.jsp";
		}else if(!pageFive){
